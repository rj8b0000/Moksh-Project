      ...
      <View style={styles.content}>
        ...
        <View style={styles.terms}>
          <View style={styles.checkParent}>
            <CheckBox isChecked={isChecked.stmt1} onClick={()=>setIsChecked({...isChecked, stmt1: !isChecked.stmt1})} checkBoxColor="#9E0E10"/>
          ...
          <View style={styles.checkGroup}>
            ...
            <CheckBox isChecked={isChecked.stmt2} onClick={()=>setIsChecked({...isChecked, stmt2: !isChecked.stmt2})} checkBoxColor="#9E0E10"/>
          ...
          <View style={styles.checkGroup}>
            {/* <RadioForm/> */}
            <CheckBox isChecked={isChecked.stmt3} onClick={()=>setIsChecked({...isChecked, stmt3: !isChecked.stmt3})} checkBoxColor="#9E0E10"/>
